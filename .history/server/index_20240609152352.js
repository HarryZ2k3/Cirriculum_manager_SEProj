...
app.post('/login', (req, res)=> {
    ...
    const SQL = 'SELECT * FROM ACCOUNT.AdminAccounts WHERE Username = ? && Password = ?' INSERT INTO ACCOUNT.AdminAccounts (AdminID, Username, Password) VALUE (21, miamia, 'thaomy')
