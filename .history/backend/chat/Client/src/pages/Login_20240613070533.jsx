...
import { Alert, Button, Form, Row, Col, Stack } from "react-bootstrap";
import logo from '../pages/LoginSign/assets/person.png'
const Login = () => {
    const { loginUser, loginError, loginInfo, updateLoginInfo, isLoginLoading } = useContext(AuthContext);
    return (
    <div className='flex items-center overflow-auto hadow-lg shadow-blue-500/50 m-auto h-screen w-full bg-gradient-to-b from-background_top via-background_mid to-background_bottom'>
        <div className='flex h-3/4 w-9/12 m-auto justify-between '>
            <div className='flex flex-col w-9/12 h-screen m-auto overflow-hidden relative'>
                <img src = {bg_img}></img>
            ...
            <div className='formDiv flex itemrs-center justify-center'>
