...
const Subject = () => {
  ...
  return (
    <Transition className="flex flex-grow bg-gradient-to-b from-background_top via-background_mid to-background_bottom">
      ...
      {/* Grade Table 3/4 */}
      <div className="flex w-2/3 flex-col overflow-auto px-4 py-2 border border-black">
          <div className = "flex w-full justify-self-top">
              <LineChart className = "w-1/2 max-w-md h-64 p-4 bg-white shadow-md rounded-lg"/>
              <GPAChart className = "w-1/2 max-w-md h-64 p-4 bg-white shadow-md rounded-lg"/>
              <PieChart className='border border-black'/>
          </div>
          <div className = "flex w-2/3 item-center justify-center">
              <PieChart className='border border-black'/>
          </div>
