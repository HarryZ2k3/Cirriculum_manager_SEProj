      ...
      <div className="flex w-1/3 flex-col justify-between overflow-hidden px-8 py-4">
        ...
        <div className="mt-4 flex flex-col items-center justify-center gap-3 bg-white p-4 rounded-lg shadow">
          ...
          <div className="flex rounded">
            ...
            <Navbar bg ="dark " className ="mb-4" style={{height:"3.0rem"}}>
        <Container>
            {/* <h2>
            ...
            <Nav>
                <Stack direction= "horizontal" gap ={3}>
                    {
                        user && (<>
                         <Link onClick={()=> logoutUser()} to ="/login" className="link-light rounded text-decoration-none">
                            Logout
                        </Link>  
                        </>)
                    }
                    {!user && (<>
                    <Link to ="/login" className="link-light text-decoration-none rounded">
                        Login
                    </Link>  
