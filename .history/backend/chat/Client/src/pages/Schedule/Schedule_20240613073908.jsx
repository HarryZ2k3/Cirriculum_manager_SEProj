...
const MonthView = () => {
  ...
  return (
    <Transition className="bg-gradient-to-b from-background_top via-background_mid to-background_bottom">
    <div className="bg-white p-4 rounded shadow overflow-auto">
      ...
      <div className="grid grid-cols-7 gap-1 overflow-auto">
        ...
        {days.map((day, index) => (
          <div key={index} className={`border p-2 h-32 gap-3 ${day.month() !== moment().month() ? 'bg-gray-100' : ''}`}>
