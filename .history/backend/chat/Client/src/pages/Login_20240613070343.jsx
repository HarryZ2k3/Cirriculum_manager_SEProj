...
const Login = () => {
    const { loginUser, loginError, loginInfo, updateLoginInfo, isLoginLoading } = useContext(AuthContext);
    return (
    <div className='flex items-center overflow-hidden hadow-lg shadow-blue-500/50 m-auto h-screen w-full bg-gradient-to-b from-background_top via-background_mid to-background_bottom'>
