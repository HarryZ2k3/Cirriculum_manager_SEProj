...
const Profile = () => {
  ...
  return (
    <Container className="flex flex-col justify-center h-screen item-center overflow-auto overflow-auto"> 
      <Paper elevation={4} className="max-w-4xl w-full overflow-auto">
        {isEditing ? (
