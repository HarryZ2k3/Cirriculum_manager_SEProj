...
export default function Schedule() {
	return (
		<Transition className="flex flex-grow w-full overflow-y-auto">
			<div className="flex flex-grow w-ful">
				<table id="ContentPlaceHolderTable1" class="classTable" cellspacing="0" cellpadding="1">
					<div>
						<tr id="ContentPlaceHolderTableRow" class="center" >
