...
import FullCalendar from '@fullcalendar/react'; // Corrected component name
...
function Schedule () {
    ...
    <Transition className="bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100% overflow-y-auto">
      ...
      {/* <FullCalendar
        plugins = {[daygripPlugin, timegridPlugin, interactionPlugin]}
        initialView = "dayGripMonth"
        headerToolbar = {{
          start: "today prev,next",
          center: "title",
          end: "dayGripMonth,timeGripWeek,timeGripDay",
        }
        }
        height = {"90vh"}
        /> */}
