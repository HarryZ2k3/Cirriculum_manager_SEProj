...
import { Avatar, Box, TextField, Button, Typography, Paper, Grid, List, ListItem, ListItemAvatar, ListItemText, Divider } from '@mui/material';
      ...
      <Grid container component={Paper} className="chat-box">
        <Grid item xs={3} className="sidebar">
          <Box className="search-bar">
            <SearchIcon />
            <TextField placeholder="Search Messenger" variant="outlined" fullWidth />
          </Box>
          <List>
        ...
        <Grid item xs={9} className="chat-window">
          ...
          <form onSubmit={handleSubmit} className="message-form">
            <TextField
              ...
              fullWidth
            />
            <Button type="submit" variant="contained" color="primary" className="send-button">
              <SendIcon />
            </Button>
          </form>
        </Grid>
