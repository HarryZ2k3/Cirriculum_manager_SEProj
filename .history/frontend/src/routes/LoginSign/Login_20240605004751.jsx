...
const Login = () => {
  ...
  return (
    <Transition className='flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%'>
			...
			{/*Right-Information*/}
      <div className="flex flex-col w-1/2 items-center justify-center font-bold">    <form className="w-1/2 gap-6" onSubmit={handleLogin}>
           <p className="text-3xl mb-5">Log in</p>
           <label className="font-medium">Email</label>
           <input
    //         type="text"
    ...
    //       <button
    //         type="submit"
    //         className="bg-blue p-4 my-5 rounded-lg text-white font-semibold w-full">Log in
    //       </button>
    //     </form>
    //     <div className="text-center flex p-2">
    //       Don't have an account?
