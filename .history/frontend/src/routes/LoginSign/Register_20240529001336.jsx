...
const Register = () => {
	...
	return (
		<Transition className='flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%'>
			{/*Left-Image*/}
			<div className='flex w-2/3 flex-grow flex-col overflow-hidden px-8 py-2 rounded-lg font'>
				<img src="./assets/register.png" alt="bg img" />
				<div className='font-bold flex overflow-y-auto text-4xl justify-center items-center flex flex-col transform -translate-y-8'>
					<div className='text-center'>
						<p className='text-center p-1 mb-1'>Student Records Management</p>
