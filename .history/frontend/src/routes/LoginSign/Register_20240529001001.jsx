...
const Register = () => {
	...
	return (
		<Transition className='flex justify-center items-center flex-col'>
			<div className='flex h-screen flex-grow overflow-auto'> 
				{/*Left-Image*/}
				<div className='flex w-2/3 flex-grow justify-between rounded-lg bound'>
					<img src="./assets/register.png" alt="bg img" />
					<div className='font-bold flex overflow-y-auto text-4xl w-1/2 justify-center items-center flex flex-col transform -translate-y-8'>
						<div className='text-center'>
							<p className='p-1 mb-1'>Student Records Management</p>
