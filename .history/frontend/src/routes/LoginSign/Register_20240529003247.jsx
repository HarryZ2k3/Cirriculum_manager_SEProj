...
import password_icon from '../LoginSign/assets/password.png'
	...
	return (
		<Transition className='flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%'>
			...
			<div className='flex w-2/3 flex-grow flex-col overflow-hidden px-8 py-2 rounded-lg'>
				...
				<img src="../LoginSign/assets/register.png" alt="bg img" />
			</div>
			{/*Right-Information*/}
			<div className="flex w-3/4 flex-grow flex-col justify-between overflow-y-auto px-8 py-4 rounded-lg items-center">
				<form className='w-3/4' onSubmit={handleRegister}>
          			<p className='text-5xl mb-5 font-semibold text-center'>Register</p>
