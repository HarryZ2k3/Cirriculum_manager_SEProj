        ...
        {/* Link to Profile */}
            <div className="flex items-center justify-evenly gap-2">
                    <div className="rounded-lg px-3 text-center">
                        <Link to="/profile">
                            <button className=""flex items-center justify-evenly gap-4 "rounded-2xl bg-white text-black p-2 px-3">
                                Save
                            </button>
                        </Link>
                    </div>
                    <div className="rounded-lg px-3 text-center">
                        <Link to="/profile">
                            <button className="flex w-[80%] items-center justify-evenly gap-4 rounded-2xl bg-white text-black p-2 px-3">
                                Cancel
                            </button>
                        </Link>
                    </div>
