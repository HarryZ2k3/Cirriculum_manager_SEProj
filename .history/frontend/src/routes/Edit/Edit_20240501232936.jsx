...
function Edit() {
  return (
      ...
      <div className="flex w-2/3 flex-grow flex-col overflow-hidden px-8 py-4">
            ...
            <div className="flex w-1/3 flex-grow flex-col justify-between overflow-hidden px-8 py-4">
        {/* Link to Profile */}
            <div className="flex items-center justify-evenly gap-2 bg-white text-black">
                    <div className="rounded-lg px-3 text-center">
                        <Link to="/profile">
                            <button className="rounded-2xl file:p-2 px-3">
                                Save
                            </button>
                        </Link>
                    </div>
                    <div className="rounded-lg px-3 text-center">
                        <Link to="/profile">
                            <button className="rounded-2xl p-2 px-3">
                                Cancel
                            </button>
                        </Link>
                    </div>
