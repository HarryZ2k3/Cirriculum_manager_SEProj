...
const Edit = () => {
  ...
  return (
    ...
    // </Transition>
    <Transition className="flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%"> <div className="flex w-1/3 flex-grow flex-col justify-between overflow-y-auto px-8 py-4">
    //     {/* Profile */}
    //     <div className="mt-4 flex flex-col items-center justify-center gap-3">
    //         <img
    //           className="w-48 rounded-full"
