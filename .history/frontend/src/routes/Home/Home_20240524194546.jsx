			...
			<div className="flex w-1/3 flex-grow flex-col justify-between overflow-hidden px-8 py-4">
				...
				<div className="mt-4 flex flex-col items-center justify-center gap-3">
					<img
						...
						src="https://www.google.com/search?q=+avatar+fb&tbm=isch&ved=2ahUKEwj1oqTJqKaGAxXtcPUHHSsjMoEQ2-cCegQIABAA&oq=+avatar+fb&gs_lp=EgNpbWciCiBhdmF0YXIgZmIyBRAAGIAEMgUQABiABDIFEAAYgAQyBRAAGIAEMgUQABiABDIFEAAYgAQyBRAAGIAEMgUQABiABDIFEAAYgAQyBBAAGB5IvzZQih1YizRwAXgAkAEAmAGcAaAB8AiqAQQwLjEwuAEDyAEA-AEBigILZ3dzLXdpei1pbWeoAgrCAgQQIxgnwgIHECMYJxjqAsICChAAGIAEGEMYigXCAg0QABiABBixAxhDGIoFwgIIEAAYgAQYsQOIBgE&sclient=img&ei=zItQZvWMHu3h1e8Pq8bIiQg&bih=679&biw=1280&prmd=ivsnbtz&rlz=1C5CHFA_enVN1043VN1046#imgrc=XKjW-19RuVdtVM&imgdii=SZccpGJMA-g1lM"
						alt="Avatar"
					/>
