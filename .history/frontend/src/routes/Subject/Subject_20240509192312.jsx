		...
		<Transition className="flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%">
			...
			<div className="flex w-2/3 flex-grow flex-col overflow-hidden px-8 py-4 text-black">
				<div className = "flex flex-grow flex-col overflow-hidden">
					...
					<table className=' placeholder:rounded-lg px-3 border-spacing-[7px] text-[2.5rem]table-fixed border-separate border-spacing-[40px] border border-slate-500 ... text-center'>
						<thead>
							<tr>
							<th>Inclass</th>
							<th >Midterm</th>
					...
					<table className='table-fixed border-separate border-spacing-[40px] border border-slate-500 ... text-center'>
						<thead>
							<tr>
							<th>Inclass</th>
							<th >Midterm</th>
