				...
				<div className = "flex flex-grow flex-col overflow-y-auto">
					<table className=' placeholder:rounded-lg px-3 text-[2rem] table-fixed border-separate border-spacing-[20px] border border-slate-500 ... text-center'>
						...
						<thead>
							...
							<th className=' border border-whitetext-text_blue'>Midterm</th>
							<th className=' border border-whitetext-text_blue'>Final</th>
							<th className=' border border-whitetext-text_blue'>Total</th>
							</tr>
						</thead>
						<tbody>
							<tr>
