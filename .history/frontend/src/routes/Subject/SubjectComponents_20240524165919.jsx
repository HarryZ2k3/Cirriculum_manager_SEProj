...
export const List = ({
    ...
    return (
        <button class="bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 ..."><h3 className="line-clamp-1">{subject}</h3>
