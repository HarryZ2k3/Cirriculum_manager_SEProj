...
export const List = ({
    ...
    return (
        <button className="rounded-lg padding space-y-2 bg-card_blue hover:bg-header_light active:bg-header_light focus:outline-none focus:ring focus:bg-header_light text-left px-3">
