...
export const List = ({
    ...
    return (
        <button className="rounded-lg bg-card_blue hover:bg-sky-100 active:bg-sky-00 focus:outline-none focus:selection focus:ring-sky-100 text-left px-3 group-hover:text-white text-sm">
