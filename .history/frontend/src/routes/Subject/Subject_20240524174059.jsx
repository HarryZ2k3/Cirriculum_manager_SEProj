					...
					<table className=' placeholder:rounded-lg px-3 text-[2rem] table-fixed border-separate border-spacing-[20px] border border-slate-500 ... text-center'>
						...
						{/* <table className='placeholder:rounded-lg px-3 text-[1.5rem] table-fixed  border border-separate border-spacing-[10px]  border-slate-500 ... text-left '> */}
							...
							<tbody className='text-[1rem]'>
								<tr>
								<td className='border border-white text-text_blue'>Assigment 1: Connect device</td>
								<td className='border border-white text-text_blue'>23/10/24</td>
								<td className='border border-white text-text_blue'>80</td>
								<td className='border border-white text-text_blue'>Individual</td>
								</tr>
								<tr>
								<t className='border border-slate-600 border-spacing-2'>Assigment 1: Connect device</t>
								<td className='border border-slate-600 border-spacing-2'>23/10/24</td>
								<td className='border border-slate-600 border-spacing-2'>80</td>
								<td className='border border-slate-600 border-spacing-2'>Individual</td>
								</tr>
								<tr>
								<td className='border border-slate-600 border-spacing-2'>Assigment 1: Connect device</td>
								<td className='border border-slate-600 border-spacing-2'>23/10/24</td>
								<td className='border border-slate-600 border-spacing-2'>80</td>
								<td className='border border-slate-600 border-spacing-2'>Individual</td>
								</tr>
