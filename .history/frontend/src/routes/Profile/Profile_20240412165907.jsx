...
export default function Profile() {
	return (
      ...
      <div className = "flex w-1/3 flex-col flew-col items-center justify-center overflow-hideen px-8 py-4 bg-black">
          <div className ="flex w-[100%] items-center justify-evenly gap-4 rounded-2xl bg-white text-black p-2 px-3">
          ...
          <img
              ...
              alt="Avatar"
          />
          <div className ="flex w-[100%] items-center justify-evenly gap-4 bg-white text-black p-2 px-3">
              <h3> JPG or PNG no larger than 5MB</h3>
          </div> 
      </div>
