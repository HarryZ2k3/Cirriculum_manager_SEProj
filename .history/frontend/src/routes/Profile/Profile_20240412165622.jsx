...
export default function Profile() {
	return (
      ...
      <div className = "flex w-1/5 flex-col flew-col items-center justify-center overflow-hideen px-8 py-4 bg-black">
          <div className ="flex w-[80%] items-center justify-evenly gap-4 rounded-4xl bg-white text-black p-2 px-3">
