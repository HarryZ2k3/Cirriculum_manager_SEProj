...
export default function Profile() {
	return (
      ...
      <div className = "flex w-1/5 flex-grow flew-col items-center justify-center overflow-hideen px-8 py-4 bg-black">
          <div className ="flex w-[80%] items-center justify-evenly gap-4 rounded-2xl bg-white text" 
          <img
