...
export const Announcement = ({
	...
	return (
		<div className="flex gap-10 rounded-xl bg-slate-300 px-6 py-4 text-4xl">
...
export const TodayClass = ({ course, teacher, room, time }) => {
	return (
		<div className="flex flex-col gap-1 rounded-2xl bg-red-300 p-4 text-[1rem]">
			<div className="flex items-center justify-between">
				<h3 className="line-clamp-1">{course}</h3>
				<h3>{teacher}</h3>
			</div>
			<div className="flex items-center justify-between">
				<h3 className="text-[1.5rem] font-semibold leading-5 text-blue-500">
					{room}
				</h3>
