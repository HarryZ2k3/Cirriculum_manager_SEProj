		...
		<Transition className="flex flex-grow bg-gradient-to-b from-background_top from-0% via-background_mid via-66% to-background_bottom to-100%">
			...
			<div className="flex w-1/3 flex-grow flex-col justify-between overflow-hidden px-8 py-4">
				...
				<div className="mt-4 flex flex-col items-center justify-center gap-3">
					...
					<button className="flex items-center justify-center gap-2 rounded-full bg-card_home px-4 py-1">
						<FaRegEdit />
						Edit Profile
					</button>
					<div className="flex w-[80%] items-center justify-evenly gap-4 rounded-2xl bg-white p-2 px-3">
						<div className="rounded-lg bg-blue-500 px-3 text-center text-white">
							<h4>Work Start</h4>
							<h4>08:00 AM</h4>
						</div>
						<div className="px-3 text-center text-back">
							<h4>Work End</h4>
							<h4>05:30 pm</h4>
						</div>
					</div>
