...
export const Announcement = ({
	...
	return (
		<div className="flex gap-10 rounded-xl px-6 py-4 text-4xl bg-card_home">
...
export const TodayClass = ({ course, teacher, room, time }) => {
	return (
		<div className="flex flex-col gap-1 rounded-2xl p-4 text-[1rem] bg-card_home text-black text">
