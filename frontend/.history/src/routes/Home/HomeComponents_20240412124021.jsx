...
export const Announcement = ({
	...
	return (
		<div className="flex gap-10 rounded-xl bg-slate-300 px-6 py-4 text-4xl bg-card_home">
			<div className="flex flex-col items-start justify-center rounded-xl bg-card_gray px-6">
				<h3>{weekdays}</h3>
...
export const TodayClass = ({ course, teacher, room, time }) => {
	return (
		<div className="flex flex-col gap-1 rounded-2xl bg-red-300 p-4 text-[1rem] bg-card_home text-black">
