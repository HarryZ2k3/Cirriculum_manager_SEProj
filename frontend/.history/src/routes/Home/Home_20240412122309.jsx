...
export default function Home() {
	return (
		<Transition className="flex flex-grow bg-gradient-to-b from-background_top to-background_bottom">
			{/* Main content 3/4 */}
			<div className="flex w-2/3 flex-grow flex-col overflow-hidden px-8 py-4">
				...
				<div className="flex h-full w-full flex-col gap-4 overflow-y-auto bg-card">
					{/* Fake data */}
