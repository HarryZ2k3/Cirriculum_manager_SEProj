...
export default function Home() {
	return (
		<Transition className="flex flex-grow divide-x-2 divide-orange-600">
			{/* Main content 3/4 */}
			<div className="flex w-3/4 flex-grow flex-col overflow-hidden px-8 py-4">
			...
			{/* Side bar 1/4 */}
			<div className="flex w-1/4 flex-grow flex-col justify-between overflow-hidden px-8 py-4">
				<div className="flex h-full w-full flex-col gap-4 overflow-y-auto">
					{/* Fake data */}
